...
MONGO_DB = getenv("MONGO_DB", "mongodb+srv://TGBot:Save@koyeb.vvt99ro.mongodb.net/?retryWrites=true&w=majority&appName=Koyeb")
LOG_GROUP = int(getenv("LOG_GROUP", "-1002193752822"))
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1002238596988"))
